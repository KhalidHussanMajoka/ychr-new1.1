            ...
            <div class="col-xl-6">
                <div class="about-one__right">
                    <div class="section-title text-left">
                        <span class="section-title__tagline">Welcome to YCHR</span>
                        <h2 class="section-title__title">Helping each other can make world better</h2>
                    </div>
                    <p class="about-one__text">Youth Commission For Human Rights (YCHR) Has Been Working In
                        The Development Sector Since 1990 And Has Undertaken Interventions With The Support
                        Of Local Community And Support Organizations Across Pakistan. We Have Extensively Served
                        In The Sectors Of Community, Social And Political Mobilization, Advocacy, Women And Human Rights,
                        Education, Health, Environmental Sanitation, Women Political Education, Gender Sensitization And
                    ...
                    <ul class="list-unstyled about-one__points">
                        <li>
                            ...
                            <div class="text">
                                ...
                                <p>please donate to make Pakistan better</p>
                            </div>
                        </li>
                    </ul>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                <div class="causes-one__single">
                    <div class="causes-one__img">
                        <img src="assets/images/resources/img-4.png" alt="">
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                <div class="causes-one__single">
                    <div class="causes-one__img">
                        <img src="assets/images/resources/partnership.png" alt="">
                        <div class="causes-one__cat">
                            <p>Women And Human Rights</p>
                        </div>
                    </div>
                    <div class="causes-one__content">
                        <h3 class="causes-one__title"><a href="donation-details.php">Human Righs in Pakistan is the main issue</a>
                        </h3>
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                <div class="causes-one__single">
                    ...
                    <div class="causes-one__content">
                        <h3 class="causes-one__title"><a href="donation-details.php"> Economic And Political
                                Empowerment</a>
                        </h3>
...
<section class="become-volunteer-one">
    <div class="become-volunteer-one__bg-box">
        <div class="become-volunteer-one__bg jarallax" data-jarallax data-speed="0.2" data-imgPosition="50% 0%" style="background-image: url(assets/images/backgrounds/bg.webp);"></div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4">
                <div class="events-one__left">
                    <div class="section-title text-left">
                        <span class="section-title__tagline">Our Upcoming events</span>
                ...
                <div class="events-one__right">
                    <div class="events-one__carousel owl-carousel owl-theme thm-owl__carousel" data-owl-options='{
                        ...
                        <div class="item">
                            ...
                            <div class="events-one__single">
                                <div class="events-one__img">
                                    <img src="assets/images/events/146-111.jpg" style="height:50vh; width:120%" alt="">
                        ...
                        <div class="item">
                            ...
                            <div class="events-one__single">
                                <div class="events-one__img">
                                    <img src="assets/images/events/132-111.jpg" style="height:50vh; width:120%" alt="">
                                    <div class="events-one__date">
                                        <p>23 May, 2022</p>
                                    </div>
                                    <div class="events-one__content">
                        ...
                        <div class="item">
                            ...
                            <div class="events-one__single">
                                <div class="events-one__img">
                                    <img src="assets/images/events/125-111-1.png" style="height:50vh; width:120%" alt="">
                                    <div class="events-one__date">
                                        <p>23 May, 2022</p>
                                    </div>
                                    <div class="events-one__content">
                        ...
                        <div class="item">
                            ...
                            <div class="events-one__single">
                                <div class="events-one__img">
                                    <img src="assets/images/events/130-111.jpg" style="height:50vh; width:120%" alt="">
                                    <div class="events-one__date">
                                        <p>23 May, 2022</p>
                                    </div>
                                    <div class="events-one__content">
                        ...
                        <div class="item">
                            ...
                            <div class="events-one__single">
                                <div class="events-one__img">
                                    <img src="assets/images/events/138-111.jpg" style="height:50vh; width:120%" alt="">
                                    <div class="events-one__date">
                                        <p>23 May, 2022</p>
                                    </div>
                                    <div class="events-one__content">
        ...
        <div class="row">
            <div class="col-xl-6 col-lg-6  wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                <div class="feature-one__single">
                    ...
                    <p class="feature-one__text">Youth Commission For Human Rights (YCHR) Has Been Working In The Development Sector Since 1990..</p>
                    <ul class="list-unstyled feature-one__point">
                        <li>
                            ...
                            <div class="text">
                                <p>Your physical aid like volunteer</p>
                            </div>
                        </li>
                        <li>
                            <div class="icon">
                            ...
                            <div class="text">
                                <p>What can you do for society</p>
                            </div>
                        </li>
                        <li>
                            <div class="icon">
                            ...
                            <div class="text">
                                <p>Help to eliviate the society from proverty</p>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="feature-one__single feature-one__single--two">
                    ...
                    <ul class="list-unstyled feature-one__point">
                        <li>
                            ...
                            <div class="text">
                                <p>Send your financial aid for needy childrens</p>
                            </div>
                        </li>
                        <li>
                            <div class="icon">
                        ...
                        <li>
                            ...
                            <div class="text">
                                <p>Help through your knowledge</p>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="testimonial-one__left">
                    <div class="section-title text-left">
                        ...
                        <h2 class="section-title__title">What they are talking about YCHR</h2>
                    </div>
                    <p class="testimonial-one__text-1">What people talking about YCHR, and services which we are providing to the needy persons</p>
                    ...
                    <div class="testimonial-one__carousel owl-carousel owl-theme thm-owl__carousel" data-owl-options='{
                        ...
                        <div class="item">
                            ...
                            <div class="testimonial-one__single">
                                ...
                                <div class="testimonial-one__client-img">
                                    <img src="assets/images/testimonial/" alt="">
                                </div>
                                <div class="testimonial-one__client-info">
                                    <h3 class="testimonial-one__client-name">Hussnain Ahmad</h3>
                                    <p class="testimonial-one__client-sub-title">Volunteer</p>
                                </div>
                                <div class="testimonial-one__quote">
                                    <span class="icon-double-quotes"></span>
                                </div>
                                <p class="testimonial-one__text-2">.....</p>
                            </div>
                        ...
                        <div class="item">
                            ...
                            <div class="testimonial-one__single">
                                ...
                                <div class="testimonial-one__client-info">
                                    <h3 class="testimonial-one__client-name">Sara</h3>
                                    <p class="testimonial-one__client-sub-title">Volunteer</p>
                                </div>
                                <div class="testimonial-one__quote">
                                    <span class="icon-double-quotes"></span>
                        ...
                        <div class="item">
                            ...
                            <div class="testimonial-one__single">
                                ...
                                <div class="testimonial-one__client-info">
                                    <h3 class="testimonial-one__client-name">Danish</h3>
                                    <p class="testimonial-one__client-sub-title">Volunteer</p>
                                </div>
                                <div class="testimonial-one__quote">
                                    <span class="icon-double-quotes"></span>
                        ...
                        <div class="item">
                            ...
                            <div class="testimonial-one__single">
                                ...
                                <div class="testimonial-one__client-info">
                                    <h3 class="testimonial-one__client-name">Ahmad</h3>
                                    <p class="testimonial-one__client-sub-title">Volunteer</p>
                                </div>
                                <div class="testimonial-one__quote">
                                    <span class="icon-double-quotes"></span>
                        ...
                        <div class="item">
                            ...
                            <div class="testimonial-one__single">
                                ...
                                <div class="testimonial-one__client-info">
                                    <h3 class="testimonial-one__client-name">Sarah</h3>
                                    <p class="testimonial-one__client-sub-title">Volunteer</p>
                                </div>
                                <div class="testimonial-one__quote">
                                    <span class="icon-double-quotes"></span>
                        ...
                        <div class="item">
                            ...
                            <div class="testimonial-one__single">
                                ...
                                <div class="testimonial-one__client-info">
                                    <h3 class="testimonial-one__client-name">Talha</h3>
                                    <p class="testimonial-one__client-sub-title">Volunteer</p>
                                </div>
                                <div class="testimonial-one__quote">
                                    <span class="icon-double-quotes"></span>
            ...
            <ul class="list-unstyled gallery-one__list">
                <li class="gallery-one__single wow fadeInUp" data-wow-delay="100ms">
                    <div class="gallery-one__img">
                        <img src="assets/images/gallery/134-111.jpg" style="height:56vh;width:150%;" alt="">
                        <a href="assets/images/gallery/134-111.jpg" class="img-popup"></a>
                ...
                <li class="gallery-one__single wow fadeInUp" data-wow-delay="200ms">
                    <div class="gallery-one__img">
                        <img src="assets/images/gallery/20150912_141144.jpg" style="height:56vh;width:190%;" alt="">
                        <a href="assets/images/gallery/20150912_141144.jpg" class="img-popup"></a>
                        <div class="gallery-one__content">
                            <!-- /.img-popup -->
                            <p class="gallery-one__sub-title">Charity</p>
                            <h5 class="gallery-one__title"><a href="gallery.php">Human Rights</a></h5>
                        </div>
                    </div>
                </li>
                <li class="gallery-one__single wow fadeInUp" data-wow-delay="300ms">
                    <div class="gallery-one__img">
                        <img src="assets/images/gallery/IMG_6421.jpg" style="height:56vh;width:190%;" alt="">
                        <a href="assets/images/gallery/IMG_6421.jpg" class="img-popup"></a>
                        <div class="gallery-one__content">
                            <!-- /.img-popup -->
                            <p class="gallery-one__sub-title">Charity</p>
                            <h5 class="gallery-one__title"><a href="gallery.php">Health</a></h5>
                        </div>
                    </div>
                </li>
                <li class="gallery-one__single wow fadeInUp" data-wow-delay="400ms">
                    <div class="gallery-one__img">
                        <img src="assets/images/gallery/events2.jpg" style="height:56vh;width:190%;" alt="">
                        <a href="assets/images/gallery/events2.jpg" class="img-popup"></a>
                        <div class="gallery-one__content">
                            <!-- /.img-popup -->
                            <p class="gallery-one__sub-title">Charity</p>
                            <h5 class="gallery-one__title"><a href="gallery.php">Food</a></h5>
                        </div>
                    </div>
                </li>
                <li class="gallery-one__single wow fadeInUp" data-wow-delay="500ms">
                    <div class="gallery-one__img">
                        <img src="assets/images/gallery/131-111.jpg" style="height:56vh;width:190%;" alt="">
                        <a href="assets/images/gallery/131-111.jpg" class="img-popup"></a>
                        <div class="gallery-one__content">
                            <!-- /.img-popup -->
                            <p class="gallery-one__sub-title">Charity</p>
                            <h5 class="gallery-one__title"><a href="gallery.php">Women Empowerment</a></h5>
                        </div>
                    </div>
                </li>
            </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12 col-lg-12">
                <center>
                    <a class="" href="news-details.php">
                        <h2>Our Latest Project</h2>
                        <h3 class="news-details__title">Awami Baithaks For Peace Promotion</h3>
                    </a>
                </center>
                <div class="news-details__left">
                    <div class="news-details__img"> <img src="assets/images/gallery/144-111.jpg" alt="">
                    ...
                    <div class="news-details__content">
                        <ul class="list-unstyled news-details__meta">
                            ...
                            <li><a href="news-details.php"><i class="fas fa-comments"></i> 2 Comments</a> </li>
                        </ul>
                        <p class="news-details__text-1">YCHR, In Collaboration With US State Department, Is Working On A Project Titled “Awami Baithaks For Peace Promotion” In Districts Multan And Muzaffargarh. YCHR Has Set Up 16 Awami Baithaks (8 Each In Multan And Muzaffargarh) Each Having A 15-Member Organizing Committee Having Representation From Various Communal Background I.E. Muslim Sects, Religious Leaders, Minority Groups, Community Elders, Women And Youth In Order To Establish Sustained Inter-Communal Contact And To Demonstrate Peace, Tolerance And Inter-Communal Harmony To The Public At Large. Each Baithak Is Equipped With Major Daily Newspapers And Informative Materials On The Topics Of Human Rights,Women’s Rights,Interfaith Harmony,Peace And Tolerance. The Aim Of The Awami Baithaks Is To Serve As Nuclei For A Host Of Activities That All Aim To Build A Culture Of Religious Tolerance, Human Rights, Women’s Rights, Social Harmony,Community Cohesion,Freedom Of Expression, And Support For Democratic Values Among Youth. </p>
                        <p class="news-details__text-2">In Addition To Awami Baithak Activities In The Target Area,YCHR Is Going To Collaborate With Public And Private Schools Of The Same Area To Interact With Students And Teachers. They Will Be Encouraged To Promote Peace, Tolerance And Interfaith Harmony In The Society.They Will Be Facilitated To Learn Strategies Necessary For Preventing And Countering Violent Extremism In Their Community. Since The Young Students Are Essentially The Future Of The Target Community, This Intervention Will Have A Positive Impact On The Overall Community Mindset In The Long Run. </p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="faq-one">
    ...
    <div class="faq-one-bg" style="background-image: url(assets/images/backgrounds/128-111.jpg);"></div>
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-lg-6">
                    ...
                    <div class="accrodion-grp" data-grp-name="faq-one-accrodion">
                        <div class="accrodion active">
                            <div class="accrodion-title">
                                <h4>Youth Commission for Human Rights</h4>
                            </div>
                            <div class="accrodion-content">
                                <div class="inner">
                                    <p>Some most important questions about YCHR</p>
                                </div><!-- /.inner -->
                            </div>
                        </div>
                        <div class="accrodion">
                            ...
                            <div class="accrodion-content">
                                <div class="inner">
                                    <p>The Organization Was Formed By A Group Of Students From Punjab University, Lahore, Pakistan,
                        ...
                        <div class="accrodion">
                            <div class="accrodion-title">
                                <h4>Where YCHR Headoffice located?</h4>
                            </div>
                            <div class="accrodion-content">
                                <div class="inner">
                                    <p>Head Office, Lahore Pakistan. House No.58/44, Street 4, Block AA, Sector D, Bahria Town
                                        Lahore, Pakistan</p>
                                </div><!-- /.inner -->
                            </div>
                        </div>
                        <div class="accrodion last-chiled">
                            <div class="accrodion-title">
                                <h4>What is the main purpose of this organization?</h4>
                            </div>
                            <div class="accrodion-content">
                                <div class="inner">
                                    <p>We
                                        Have Extensively Served In The Sectors Of Community, Social And Political Mobilization,Advocacy,Women And Human
                                        Rights,Education,Health, Environmental Sanitation, Women Political Education, Gender Sensitization And Research And Training.
                                    </p>
                                </div><!-- /.inner -->
                            </div>
                        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                <div class="news-one__single">
                    <div class="news-one__img">
                        <img src="assets/images/blog/achieve-1.png" alt="">
                    </div>
                    <div class="news-one__content-box">
                        <div class="news-one__content-inner">
                            <div class="news-one__content">
                                ...
                                <h3 class="news-one__title"><a href="news-details.php">Human Right Workshops in 20 Multan Villages</a></h3>
                            </div>
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                <div class="news-one__single">
                    <div class="news-one__img">
                        <img src="assets/images/blog/achieve-4.jpg" alt="">
                    </div>
                    <div class="news-one__content-box">
                        <div class="news-one__content-inner">
                            <div class="news-one__content">
                                ...
                                <h3 class="news-one__title"><a href="news-details.php">Orientation on resolving conflicts</a></h3>
                            </div>
                            <div class="news-one__bottom">
                                <div class="news-one__read-more">
                                    <a href="news-details.php"> <span class="icon-right-arrow"></span> Read
            ...
            <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                <div class="news-one__single">
                    <div class="news-one__img">
                        <img src="assets/images/blog/achieve-3.png" alt="">
                    </div>
                    <div class="news-one__content-box">
                        <div class="news-one__content-inner">
                            <div class="news-one__content">
                                ...
                                <h3 class="news-one__title"><a href="news-details.php">Waseeb Aman Baithak (Jang News)</a></h3>
                            </div>
                            <div class="news-one__bottom">
                                <div class="news-one__read-more">
                                    <a href="news-details.php"> <span class="icon-right-arrow"></span> Read
