        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                <div class="team-one__single">
                    ...
                    <div class="team-one__content">
                        <h3 class="team-one__name"><a href="team.php">Zahid Islam</a></h3>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                <div class="team-one__single">
                    ...
                    <div class="team-one__content">
                        <h3 class="team-one__name"><a href="team-1.php">Yasmin Tahira</a></h3>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                <div class="team-one__single">
                    ...
                    <div class="team-one__content">
                        <h3 class="team-one__name"><a href="team-2.php">Umme Laila</a></h3>
                        <p class="team-one__sub-title">Member,Board OF Directors</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                <div class="team-one__single">
                    ...
                    <div class="team-one__content">
                        <h3 class="team-one__name"><a href="team-3.php">Mahum Yasin</a></h3>
                        <p class="team-one__sub-title">Member,Board OF Directors</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                <div class="team-one__single">
                    ...
                    <div class="team-one__content">
                        <h3 class="team-one__name"><a href="team-4.php">Mian Shahid Nadeem</a></h3>
                        <p class="team-one__sub-title">Member,Board OF Directors</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                <div class="team-one__single">
                    ...
                    <div class="team-one__content">
                        <h3 class="team-one__name"><a href="team-5.php">Anjum Raza</a></h3>
                        <p class="team-one__sub-title">Member,Board OF Directors</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                <div class="team-one__single">
                    <div class="team-one__img">
                        <img src="assets/images/resources/avater-1.jpg" style="height:40vh;width:100%;" alt="">
                        <div class="team-one__social">
                            <a href="#"><i class="fab fa-facebook"></i></a>
                            <a href="#"><i class="fab fa-twitter"></i></a>
                            <a href="#"><i class="fab fa-pinterest-p"></i></a>
                    ...
                    <div class="team-one__content">
                        <h3 class="team-one__name"><a href="team-6.php">Hajra Cheema</a></h3>
                        <p class="team-one__sub-title">Member,Board OF Directors</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                <div class="team-one__single">
                    ...
                    <div class="team-one__content">
                        <h3 class="team-one__name"><a href="staff-1.php">Shazia Khan</a></h3>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                <div class="team-one__single">
                    ...
                    <div class="team-one__content">
                        <h3 class="team-one__name"><a href="staff-2.php">Shazia Fida</a></h3>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                <div class="team-one__single">
                    ...
                    <div class="team-one__content">
                        <h3 class="team-one__name"><a href="staff-3.php">Kiran Bilal</a></h3>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                <div class="team-one__single">
                    <div class="team-one__img">
                        <img src="assets/images/resources/naseem-jahan.jpg" style="height:40vh;width:100%;" alt="">
                        <div class="team-one__social">
                            <a href="#"><i class="fab fa-facebook"></i></a>
                            <a href="#"><i class="fab fa-twitter"></i></a>
                            <a href="#"><i class="fab fa-pinterest-p"></i></a>
                    ...
                    <div class="team-one__content">
                        <h3 class="team-one__name"><a href="staff-5.php">Naseem Jahan</a></h3>
                        <p class="team-one__sub-title">Field Officer</p>
                    </div>
                </div>
            </div>
            <!--Team One Single End-->
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="400ms">
                <div class="team-one__single">
                    <div class="team-one__img">
                        <img src="assets/images/resources/avater.webp" style="height:40vh;width:100%;" alt="">
                        <div class="team-one__social">
                            <a href="#"><i class="fab fa-facebook"></i></a>
                            <a href="#"><i class="fab fa-twitter"></i></a>
                            <a href="#"><i class="fab fa-pinterest-p"></i></a>
                    ...
                    <div class="team-one__content">
                        <h3 class="team-one__name"><a href="staff-4.php">Mushtaq Chisti</a></h3>
